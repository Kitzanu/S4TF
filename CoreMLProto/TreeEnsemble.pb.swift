...
// Source: coremltools-master/mlmodel/format/TreeEnsemble.proto
//
...
extension CoreML_Specification_TreeEnsembleClassifier: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._treeEnsemble)
      case 2: try decoder.decodeSingularEnumField(value: &self.postEvaluationTransform)
      case 100:
