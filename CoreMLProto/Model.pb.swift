...
// Source: coremltools-master/mlmodel/format/Model.proto
//
...
struct CoreML_Specification_SerializedModel {
  ...
  var model: Data = SwiftProtobuf.Internal.emptyData
...
struct CoreML_Specification_Model {
  ...
  enum OneOf_Type: Equatable {
    ...
    static func ==(lhs: CoreML_Specification_Model.OneOf_Type, rhs: CoreML_Specification_Model.OneOf_Type) -> Bool {
      ...
      case (.serializedModel(let l), .serializedModel(let r)): return l == r
...
extension CoreML_Specification_PipelineClassifier: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._pipeline)
      default: break
      }
    }
  }
...
extension CoreML_Specification_FeatureDescription: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularStringField(value: &self.shortDescription)
...
extension CoreML_Specification_ModelDescription: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeRepeatedMessageField(value: &self.input)
      case 10: try decoder.decodeRepeatedMessageField(value: &self.output)
      case 11: try decoder.decodeSingularStringField(value: &self.predictedFeatureName)
      case 12: try decoder.decodeSingularStringField(value: &self.predictedProbabilitiesName)
      case 50: try decoder.decodeRepeatedMessageField(value: &self.trainingInput)
      case 100: try decoder.decodeSingularMessageField(value: &self._metadata)
      default: break
      }
    }
  }
...
extension CoreML_Specification_SerializedModel: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularBytesField(value: &self.model)
      default: break
      }
    }
  }
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3000:
          ...
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._type = .serializedModel(v)}
        default: break
        }
      }
    }
