...
// Source: coremltools-master/mlmodel/format/NonMaximumSuppression.proto
//
...
extension CoreML_Specification_NonMaximumSuppression: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1:
        ...
        if let v = v {self.suppressionMethod = .pickTop(v)}
      case 100:
      ...
      case 110: try decoder.decodeSingularDoubleField(value: &self.iouThreshold)
      case 111: try decoder.decodeSingularDoubleField(value: &self.confidenceThreshold)
      case 200: try decoder.decodeSingularStringField(value: &self.confidenceInputFeatureName)
      case 201: try decoder.decodeSingularStringField(value: &self.coordinatesInputFeatureName)
      case 202: try decoder.decodeSingularStringField(value: &self.iouThresholdInputFeatureName)
      case 203: try decoder.decodeSingularStringField(value: &self.confidenceThresholdInputFeatureName)
      case 210: try decoder.decodeSingularStringField(value: &self.confidenceOutputFeatureName)
      case 211: try decoder.decodeSingularStringField(value: &self.coordinatesOutputFeatureName)
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if case .pickTop(let v)? = self.suppressionMethod {
