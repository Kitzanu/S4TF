...
// Source: coremltools-master/mlmodel/format/SoundAnalysisPreprocessing.proto
//
...
extension CoreML_Specification_CoreMLModels_SoundAnalysisPreprocessing: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 20:
        ...
        if let v = v {self.soundAnalysisPreprocessingType = .vggish(v)}
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if case .vggish(let v)? = self.soundAnalysisPreprocessingType {
