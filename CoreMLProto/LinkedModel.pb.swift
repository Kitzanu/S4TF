...
// Source: coremltools-master/mlmodel/format/LinkedModel.proto
//
...
extension CoreML_Specification_LinkedModel: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1:
        ...
        if let v = v {self.linkType = .linkedModelFile(v)}
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if case .linkedModelFile(let v)? = self.linkType {
...
extension CoreML_Specification_LinkedModelFile: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._linkedModelFileName)
      case 2: try decoder.decodeSingularMessageField(value: &self._linkedModelSearchPath)
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if let v = self._linkedModelFileName {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    }
    if let v = self._linkedModelSearchPath {
