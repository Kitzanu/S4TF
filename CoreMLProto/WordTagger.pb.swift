...
// Source: coremltools-master/mlmodel/format/WordTagger.proto
//
...
extension CoreML_Specification_CoreMLModels_WordTagger: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 20: try decoder.decodeSingularStringField(value: &self.tokensOutputFeatureName)
      case 21: try decoder.decodeSingularStringField(value: &self.tokenTagsOutputFeatureName)
      case 22: try decoder.decodeSingularStringField(value: &self.tokenLocationsOutputFeatureName)
      case 23: try decoder.decodeSingularStringField(value: &self.tokenLengthsOutputFeatureName)
      ...
      case 200:
        ...
        if let v = v {self.tags = .stringTags(v)}
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if case .stringTags(let v)? = self.tags {
