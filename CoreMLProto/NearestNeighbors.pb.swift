...
// Source: coremltools-master/mlmodel/format/NearestNeighbors.proto
//
...
extension CoreML_Specification_KNearestNeighborsClassifier: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._nearestNeighborsIndex)
      case 3: try decoder.decodeSingularMessageField(value: &self._numberOfNeighbors)
      case 100:
      ...
      case 110:
        ...
        if let v = v {self.defaultClassLabel = .defaultStringLabel(v)}
      case 111:
        if self.defaultClassLabel != nil {try decoder.handleConflictingOneOf()}
        var v: Int64?
        try decoder.decodeSingularInt64Field(value: &v)
        if let v = v {self.defaultClassLabel = .defaultInt64Label(v)}
      case 200:
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.weightingScheme = .uniformWeighting(v)}
      case 210:
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.weightingScheme = .inverseDistanceWeighting(v)}
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if let v = self._nearestNeighborsIndex {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    }
    if let v = self._numberOfNeighbors {
...
extension CoreML_Specification_NearestNeighborsIndex: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularInt32Field(value: &self.numberOfDimensions)
      case 2: try decoder.decodeRepeatedMessageField(value: &self.floatSamples)
      case 100:
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.indexType = .linearIndex(v)}
      case 110:
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.indexType = .singleKdTreeIndex(v)}
      case 200:
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.distanceFunction = .squaredEuclideanDistance(v)}
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if case .squaredEuclideanDistance(let v)? = self.distanceFunction {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 200)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
