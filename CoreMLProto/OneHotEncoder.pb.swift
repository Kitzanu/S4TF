...
// Source: coremltools-master/mlmodel/format/OneHotEncoder.proto
//
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1:
        ...
        if let v = v {self.categoryType = .stringCategories(v)}
      case 2:
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.categoryType = .int64Categories(v)}
      case 10: try decoder.decodeSingularBoolField(value: &self.outputSparse)
      case 11: try decoder.decodeSingularEnumField(value: &self.handleUnknown)
      default: break
      }
    }
  }
